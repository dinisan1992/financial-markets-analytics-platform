...
try {
    Write-Host "[0/5] Runtime dependency check" -ForegroundColor Cyan
    ...
    Write-Host "[1/5] Demo unit tests" -ForegroundColor Cyan
    & $DemoPython "$DemoRoot\tests\test_demo_mode.py"

    Write-Host "[2/5] Project-aware demo smoke test" -ForegroundColor Cyan
    & $DemoPython "$DemoRoot\project_scripts\diagnostics\demo_mode_smoke.py"

    Write-Host "[3/5] Compile demo files" -ForegroundColor Cyan
    ...
    Write-Host "[4/5] Basic application import check" -ForegroundColor Cyan
