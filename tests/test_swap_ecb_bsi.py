...
from project_scripts.diagnostics.swap_ecb_bsi import build_parser, main


class SwapEcbBsiCommandTests(unittest.TestCase):
    ...
    @patch("project_scripts.diagnostics.swap_ecb_bsi.create_engine")
