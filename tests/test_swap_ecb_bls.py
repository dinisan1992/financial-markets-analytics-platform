...
from project_scripts.diagnostics.swap_ecb_bls import build_parser, main


class SwapEcbBlsCommandTests(unittest.TestCase):
    ...
    @patch("project_scripts.diagnostics.swap_ecb_bls.create_engine")
