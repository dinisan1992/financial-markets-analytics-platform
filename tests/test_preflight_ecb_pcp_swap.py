...
from project_scripts.diagnostics.preflight_ecb_pcp_swap import (
    build_parser,
    main,
)


class PreflightEcbPcpSwapCommandTests(unittest.TestCase):
    ...
    @patch(
        "project_scripts.diagnostics.preflight_ecb_pcp_swap.create_engine"
    )
